...
class SideMenuStaff extends StatelessWidget {
  @override
            ...
            child: ListView(
              ...
              children: [
                ListTile(
                  ...
                  title: Text(AppLocalizations.of(context)!.createProspect),
                ),
                ListTile(
                  onTap: () {},
                  leading: Icon(Icons.payments),
                  title: Text(AppLocalizations.of(context)!.createOpportunity),
                ),
                ListTile(
                  onTap: () {
