...
class TrackLoanApplicationsScreen
    extends GetView<TrackLoanApplicationsController> {
  TrackLoanApplicationsScreen({super.key});
                    ...
                    ? Container(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final loan = controller.loanApplications[index];
                            return GestureDetector(
                              onTap: () {
                                /*     Get.offNamed(routesGuide.mangeLoanDetailScreen,
                                    arguments: loan.id); */
                              },
